    ...
    <div className="newproduct-container">
      <div className="newproduct-max-width">
        <div className="newproduct-header">
          ...
          <p className="newproduct-subtitle">Choose the perfect plan for your business needs</p>
        </div>
              ...
              <div className="newproduct-plan-section">
                ...
                <div className="newproduct-plan-details">
                  <div className="newproduct-plan-item">
                    ...
                    <span className="newproduct-plan-value">{product.specialPlan.facilitators}</span>
                  </div>
                  
                  <div className="newproduct-plan-item">
                    <span className="newproduct-plan-label">Languages</span>
                    <span className="newproduct-plan-value">{product.specialPlan.extraTools}</span>
                  </div>
                  ...
                  <div className="newproduct-plan-item">
                    ...
                    <span className="newproduct-plan-value">
                      ...
                      <span className="newproduct-plan-unit">{product.specialPlan.customersUnit}</span>
                    </span>
                  </div>
                  ...
                  <div className="newproduct-plan-item">
                    ...
                    <span className="newproduct-plan-value">
                      ...
                      <span className="newproduct-plan-unit">{product.specialPlan.minuteUnit}</span>
                    </span>
                  </div>
                </div>
                ...
                <div className="newproduct-capabilities-list">
                  {product.capabilities.map((capability, capIndex) => (
                    <div key={capIndex} className="newproduct-capability-item">
                      ...
                      <span className="newproduct-capability-text">{capability}</span>
                    </div>
                  ))}
                </div>
              </div>
